  ...
  <div class="relative bg-gradient-to-r from-blue-900 to-blue-700 rounded-2xl shadow-lg overflow-hidden mb-8 text-white">
    ...
    <div class="relative z-10 px-6 py-8 md:py-10 flex flex-col md:flex-row items-center justify-between gap-4">
      <div>
        ...
        <div class="mt-3 inline-block bg-blue-800/50 px-3 py-1 rounded-full text-xs font-medium border border-blue-500">
          👋 Halo, {{ Auth::user()->name }}!
        </div>
      </div>
    ...
    @foreach ($candidates as $candidate)
      <div x-data="{ activeTab: 'visi' }"
          ...
          <div class="p-5 h-48 overflow-y-auto bg-white custom-scrollbar">
            ...
            <div x-show="activeTab === 'visi'" x-transition.opacity>
              <div class="flex gap-2 mb-2">
                <span class="bg-blue-100 text-blue-700 text-[10px] font-bold px-2 py-0.5 rounded">VISI</span>
              </div>
            ...
            <div x-show="activeTab === 'misi'" x-transition.opacity style="display: none;">
              <div class="flex gap-2 mb-2">
                <span class="bg-purple-100 text-purple-700 text-[10px] font-bold px-2 py-0.5 rounded">MISI</span>
              </div>
            ...
            <div x-show="activeTab === 'program'" x-transition.opacity style="display: none;">
              <div class="flex gap-2 mb-2">
                <span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-0.5 rounded">UNGGULAN</span>
              </div>
        ...
        <div class="p-4 bg-gray-50 border-t border-gray-100">
          ...
          @else
            <form id="vote-form-{{ $candidate->id }}" action="{{ route('vote.store', $candidate->id) }}" method="POST">
              @csrf
              <button type="button"
