            ...
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3 group">
                    <div
                        ...
                        <div
                            class="absolute -top-1 -right-1 w-3 h-3 bg-green-400 rounded-full border-2 border-blue-900">
                        </div>
                    </div>
                ...
                <div class="hidden md:flex items-center gap-6">
                    @auth
                        ...
                        <div
                            class="flex items-center gap-3 bg-blue-800/50 py-1.5 px-4 rounded-full border border-blue-700/50">
                            <div
